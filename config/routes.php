...
$router->get('/school/finance/expenses/export',              ['ExpenseController', 'exportCsv']);
$router->post('/school/finance/expenses/{id}/update',        ['ExpenseController', 'update']);
$router->post('/school/finance/expenses/{id}/cancel',        ['ExpenseController', 'cancel']);
$router->post('/school/finance/expenses/{id}/decide',        ['ExpenseController', 'decide']);
$router->get('/school/finance/expense-approvals',            ['ExpenseController', 'approvals']);
$router->get('/school/finance/collections',                  ['CollectionController', 'index']);
$router->post('/school/finance/collections/store',           ['CollectionController', 'store']);
$router->post('/school/finance/collections/{id}/cancel',     ['CollectionController', 'cancel']);
$router->post('/school/finance/collections/{id}/settle',     ['CollectionController', 'settle']);
$router->get('/school/finance/collections/{id}/receipt',     ['CollectionController', 'receipt']);
$router->get('/school/finance/arrears-collection',           ['ArrearsController', 'collection']);
$router->post('/school/finance/invoices/{id}/write-off',     ['ArrearsController', 'writeOff']);
$router->get('/school/finance/arrears-overrides',            ['ArrearsController', 'overrides']);
$router->post('/school/finance/arrears-overrides/{id}/decide', ['ArrearsController', 'decide']);
$router->get('/school/finance/profit-loss',                  ['FinancialRecordsController', 'profitLoss']);
...
$router->post('/school/finance/settings/categories/merge',   ['FinanceSettingsController', 'merge']);
$router->get('/school/payroll',                              ['PayrollController', 'index']);
$router->post('/school/payroll/profiles/save',               ['PayrollController', 'saveProfile']);
$router->post('/school/payroll/components/save',             ['PayrollController', 'saveComponent']);
$router->post('/school/payroll/components/{id}/delete',      ['PayrollController', 'deleteComponent']);
$router->post('/school/payroll/taxes/save',                  ['PayrollController', 'saveTax']);
$router->post('/school/payroll/taxes/{id}/delete',           ['PayrollController', 'deleteTax']);
$router->post('/school/payroll/calculate',                   ['PayrollController', 'calculate']);
$router->post('/school/payroll/action',                      ['PayrollController', 'action']);
$router->get('/school/payroll/export',                       ['PayrollController', 'exportCsv']);
