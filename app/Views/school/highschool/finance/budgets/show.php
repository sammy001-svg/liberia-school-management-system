...
<div class="card" style="margin-top:20px;">
  <div class="card-header">
    ...
    <a href="<?= $cfg['url'] ?>/school/finance/collections" class="btn btn-sm btn-primary">Record in Extra Collections</a>
  </div>
  ...
  <div class="table-wrapper"><table>
    ...
    <tbody>
      ...
      <tr><td colspan="4"><div class="empty-state"><div class="empty-state-icon">💰</div><div class="empty-state-text">No non-fee income recorded in this period.</div></div></td></tr>
      <?php endif; ?>
    </tbody>
  </table></div>
</div>
