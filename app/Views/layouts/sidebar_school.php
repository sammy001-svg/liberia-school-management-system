...
// Each item is only rendered if the logged-in role is in its 'roles' list, and a
// section header is only rendered if at least one of its items is visible — this
// keeps Accountant/Staff/Teacher accounts from seeing (or reaching) modules that
// requireAuth() would reject them from anyway.
$ALL = ['School Admin','Teacher','Accountant','Staff'];
$sections = [
    ['label' => 'Overview', 'items' => [
        ['url'=>'/school/dashboard', 'label'=>'Dashboard', 'roles'=>$ALL,
    ...
    ['label' => 'People', 'items' => [
        ['url'=>'/school/students', 'label'=>'Students', 'roles'=>['School Admin','Teacher','Staff'],
        ...
        ['url'=>'/school/teachers', 'label'=>'Teachers', 'roles'=>['School Admin'],
        ...
        ['url'=>'/school/parents', 'label'=>'Parents', 'roles'=>['School Admin'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/>'],
    ]],
    ['label' => 'Academics', 'items' => [
        ['url'=>'/school/classes', 'label'=>'Classes', 'roles'=>['School Admin','Teacher'],
        ...
        ['url'=>'/school/courses', 'label'=>'Courses / Subjects', 'roles'=>['School Admin','Teacher'],
        ...
        ['url'=>'/school/attendance', 'label'=>'Attendance', 'roles'=>['School Admin','Teacher'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>'],
        ['url'=>'/school/timetable', 'label'=>'Timetable', 'roles'=>['School Admin','Teacher'],
        ...
        ['url'=>'/school/grades', 'label'=>'Grades & Exams', 'roles'=>['School Admin','Teacher'],
        ...
        ['url'=>'/school/certificates', 'label'=>'Certificates', 'roles'=>['School Admin'],
    ...
    ['label' => 'Online Learning', 'items' => [
        ['url'=>'/school/homework', 'label'=>'Homework', 'roles'=>['School Admin','Teacher'],
        ...
        ['url'=>'/school/online-classes', 'label'=>'Online Classes', 'roles'=>['School Admin','Teacher'],
        ...
        ['url'=>'/school/online-exams', 'label'=>'Online Exams', 'roles'=>['School Admin','Teacher'],
    ...
    ['label' => 'Transport', 'items' => [
        ['url'=>'/school/transport/buses', 'label'=>'Buses', 'roles'=>['School Admin'],
        ...
        ['url'=>'/school/transport/drivers', 'label'=>'Drivers', 'roles'=>['School Admin'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z"/>'],
        ['url'=>'/school/transport/routes', 'label'=>'Routes', 'roles'=>['School Admin','Accountant'],
    ...
    ['label' => 'Administration', 'items' => [
        ['url'=>'/school/staff', 'label'=>'Staff', 'roles'=>['School Admin','Accountant'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z"/>'],
        ['url'=>'/school/hr/payroll', 'label'=>'Staff Payroll', 'roles'=>['School Admin','Accountant'],
        ...
        ['url'=>'/school/hr/leaves', 'label'=>'Leave Mgmt', 'roles'=>['School Admin','Accountant'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5"/>'],
        ['url'=>'/school/departments', 'label'=>'Departments', 'roles'=>['School Admin'],
        ...
        ['url'=>'/school/academic-years', 'label'=>'Academic Years', 'roles'=>['School Admin'],
        ...
        ['url'=>'/school/inventory', 'label'=>'Inventory', 'roles'=>['School Admin','Staff'],
        ...
        ['url'=>'/school/library', 'label'=>'Library', 'roles'=>['School Admin','Staff'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25"/>'],
    ]],
    ['label' => 'Insights & Reporting', 'items' => [
        ['url'=>'/school/analytics', 'label'=>'Academic Analytics', 'roles'=>['School Admin','Teacher'],
        ...
        ['url'=>'/school/analytics/attendance', 'label'=>'Attendance Heatmap', 'roles'=>['School Admin','Teacher'],
        ...
        ['url'=>'/school/finance/reports', 'label'=>'Financial Reports', 'roles'=>['School Admin','Accountant'],
    ...
    ['label' => 'Finance', 'items' => [
        ['url'=>'/school/finance', 'label'=>'Finance', 'roles'=>['School Admin','Accountant'],
    ...
    ['label' => 'Communication', 'items' => [
        ['url'=>'/school/announcements', 'label'=>'Announcements', 'roles'=>['School Admin','Teacher'],
        ...
        ['url'=>'/school/messages', 'label'=>'Messages', 'roles'=>$ALL,
    ...
    ['label' => 'Settings', 'items' => [
        ['url'=>'/school/settings', 'label'=>'Settings', 'roles'=>['School Admin'],
...
<?php foreach ($sections as $section): ?>
  <?php $items = array_filter($section['items'], fn($i) => in_array($role, $i['roles'], true)); ?>
