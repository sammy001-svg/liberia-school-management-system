...
// of its items is visible — this keeps any role (default or custom, via the
// Roles & Permissions screen) from seeing modules requirePermission() would
// reject them from anyway. An empty 'perms' list means "visible to any
// logged-in school-panel user" (e.g. Dashboard, Messages).
// Each section's 'accent'/'soft' pair colors its label dot, item icons, and
// hover/active states (vars defined in style.css's accent palette).
$sections = [
    ['label' => 'Overview', 'accent' => 'var(--primary)', 'soft' => 'var(--primary-soft)', 'items' => [
        ['url'=>'/school/dashboard', 'label'=>'Dashboard', 'perms'=>[],
        ...
        ['url'=>'/school/my-leave', 'label'=>'My Leave', 'perms'=>[],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5m-13.5 3h13.5"/>'],
        ['url'=>'/school/my-payroll', 'label'=>'My Payroll', 'perms'=>[],
    ...
    ['label' => 'People', 'accent' => 'var(--purple)', 'soft' => 'var(--purple-soft)', 'items' => [
        ['url'=>'/school/students', 'label'=>'Students', 'perms'=>['students.view','students.edit','students.manage'],
        ...
        ['url'=>'/school/teachers', 'label'=>'Teachers', 'perms'=>['teachers.manage'],
        ...
        ['url'=>'/school/parents', 'label'=>'Parents', 'perms'=>['parents.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/>'],
        ['url'=>'/school/admissions', 'label'=>'Online Applications', 'perms'=>['admissions.manage'],
    ...
    ['label' => 'Academics', 'accent' => 'var(--blue)', 'soft' => 'var(--blue-soft)', 'items' => [
        ...
        ['url'=>'/school/discipline', 'label'=>'Discipline', 'perms'=>['discipline.manage'],
        ...
        ['url'=>'/school/grades', 'label'=>'Grades & Exams', 'perms'=>['grades.manage'],
        ...
        ['url'=>'/school/grades/marking-periods', 'label'=>'Marking Periods', 'perms'=>['grades.manage'],
        ...
        ['url'=>'/school/grades/approvals', 'label'=>'Grade Approvals', 'perms'=>['grades.approve','grades.manage'],
        ...
        ['url'=>'/school/grades/promotions', 'label'=>'Promotion Statements', 'perms'=>['grades.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 00-.491 6.347A48.62 48.62 0 0112 20.904a48.62 48.62 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.636 50.636 0 00-2.658-.813A59.906 59.906 0 0112 3.493a59.903 59.903 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5"/>'],
        ['url'=>'/school/certificates', 'label'=>'Certificates', 'perms'=>['certificates.manage'],
    ...
    ['label' => 'Online Learning', 'accent' => 'var(--pink)', 'soft' => 'var(--pink-soft)', 'items' => [
        ['url'=>'/school/homework', 'label'=>'Homework', 'perms'=>['homework.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"/><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5h9a3 3 0 013 3v9a3 3 0 01-3 3h-9a3 3 0 01-3-3v-9a3 3 0 013-3z"/>'],
        ['url'=>'/school/online-classes', 'label'=>'Online Classes', 'perms'=>['online_class.manage'],
        ...
        ['url'=>'/school/online-exams', 'label'=>'Online Exams', 'perms'=>['online_exam.manage'],
    ...
    ['label' => 'Transport', 'accent' => 'var(--amber)', 'soft' => 'var(--amber-soft)', 'items' => [
        ['url'=>'/school/transport/buses', 'label'=>'Buses', 'perms'=>['bus.manage'],
        ...
        ['url'=>'/school/transport/drivers', 'label'=>'Drivers', 'perms'=>['bus.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z"/>'],
        ['url'=>'/school/transport/routes', 'label'=>'Routes', 'perms'=>['bus.manage','bus.fees'],
    ...
    ['label' => 'Administration', 'accent' => 'var(--teal)', 'soft' => 'var(--teal-soft)', 'items' => [
        ['url'=>'/school/staff', 'label'=>'Staff', 'perms'=>['staff.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z"/>'],
        ['url'=>'/school/payroll', 'label'=>'Staff Payroll', 'perms'=>['hr.manage'],
        ...
        ['url'=>'/school/hr/leaves', 'label'=>'Leave Approvals', 'perms'=>['hr.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5"/>'],
        ['url'=>'/school/departments', 'label'=>'Departments', 'perms'=>['academics.manage'],
        ...
        ['url'=>'/school/academic-years', 'label'=>'Academic Years', 'perms'=>['academic.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5m-13.5 3h13.5"/>'],
        ['url'=>'/school/inventory', 'label'=>'Inventory', 'perms'=>['inventory.manage'],
        ...
        ['url'=>'/school/library', 'label'=>'Library', 'perms'=>['inventory.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25"/>'],
        ['url'=>'/school/roles', 'label'=>'Roles & Permissions', 'perms'=>['roles.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z"/>'],
        ['url'=>'/school/users', 'label'=>'Login Accounts', 'perms'=>['roles.manage'],
    ...
    ['label' => 'Insights & Reporting', 'accent' => 'var(--indigo)', 'soft' => 'var(--indigo-soft)', 'items' => [
        ['url'=>'/school/analytics', 'label'=>'Academic Analytics', 'perms'=>['analytics.view'],
        ...
        ['url'=>'/school/analytics/attendance', 'label'=>'Attendance Heatmap', 'perms'=>['analytics.view'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.48z"/>'],
        ['url'=>'/school/finance/profit-loss', 'label'=>'Financial Reports', 'perms'=>['finance.manage'],
    ...
    ['label' => 'Finance', 'accent' => 'var(--orange)', 'soft' => 'var(--orange-soft)', 'items' => [
        ['url'=>'/school/finance', 'label'=>'Financial Records', 'perms'=>['finance.manage'],
        ...
        ['url'=>'/school/finance/enrollment', 'label'=>'Enrollment', 'perms'=>['finance.accounts','finance.manage'],
        ...
        ['url'=>'/school/finance/fees-payment', 'label'=>'Fees Payment', 'perms'=>['finance.accounts','finance.manage'],
        ...
        ['url'=>'/school/finance/billing', 'label'=>'Billing Setup', 'perms'=>['finance.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z"/>'],
        ['url'=>'/school/finance/expenses', 'label'=>'Expenses', 'perms'=>['finance.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6L9 12.75l4.286-4.286a11.948 11.948 0 014.306 6.43l.776 2.898m0 0l3.182-5.511m-3.182 5.51l-5.511-3.181"/>'],
        ['url'=>'/school/finance/collections', 'label'=>'Extra Collections', 'perms'=>['finance.manage'],
        ...
        ['url'=>'/school/finance/bus-billing', 'label'=>'Bus Billing', 'perms'=>['finance.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12"/>'],
        ['url'=>'/school/finance/arrears-collection', 'label'=>'Arrears', 'perms'=>['finance.accounts','finance.manage'],
        ...
        ['url'=>'/school/finance/arrears-overrides', 'label'=>'Arrears Overrides', 'perms'=>['finance.accounts','finance.manage'],
        ...
        ['url'=>'/school/finance/statements', 'label'=>'Statements', 'perms'=>['finance.accounts','finance.manage'],
        ...
        ['url'=>'/school/finance/profit-loss', 'label'=>'Profit & Loss', 'perms'=>['finance.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z"/>'],
        ['url'=>'/school/finance/daily-receipts', 'label'=>'Daily Receipts', 'perms'=>['finance.accounts','finance.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5"/>'],
        ['url'=>'/school/finance/budgets', 'label'=>'Budget', 'perms'=>['budget.manage','finance.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z"/>'],
        ['url'=>'/school/payroll', 'label'=>'Payroll', 'perms'=>['hr.manage','finance.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M21 12a2.25 2.25 0 00-2.25-2.25H15a3 3 0 11-6 0H5.25A2.25 2.25 0 003 12m18 0v6a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18v-6m18 0V9M3 12V9m18 0a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 9m18 0V6a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 6v3"/>'],
        ...
        ['url'=>'/school/finance/settings', 'label'=>'Finance Settings', 'perms'=>['finance.manage','settings.manage'],
    ...
    ['label' => 'Communication', 'accent' => 'var(--cyan)', 'soft' => 'var(--cyan-soft)', 'items' => [
        ...
        ['url'=>'/school/messages', 'label'=>'Messages', 'perms'=>[],
    ...
    ['label' => 'Settings', 'accent' => 'var(--rose)', 'soft' => 'var(--rose-soft)', 'items' => [
        ['url'=>'/school/settings/login-slides', 'label'=>'Login Carousel', 'perms'=>['settings.manage'],
        ...
        ['url'=>'/school/settings', 'label'=>'Settings', 'perms'=>['settings.manage'],
    ...
    // Directly under Settings: the public website's own editor (see WebsiteAdminController).
    ['label' => 'Website', 'accent' => 'var(--purple)', 'soft' => 'var(--purple-soft)', 'items' => [
        ['url'=>'/school/website', 'label'=>'Website & Pages', 'perms'=>['website.manage','settings.manage'],
        ...
        ['url'=>'/school/website/news', 'label'=>'Website News & Events', 'perms'=>['website.manage','settings.manage'],
        ...
        ['url'=>'/school/website/gallery', 'label'=>'Website Gallery', 'perms'=>['website.manage','settings.manage'],
         'icon'=>'<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"/>'],
        ['url'=>'/school/website/leaders', 'label'=>'Leadership Team', 'perms'=>['website.manage','settings.manage'],
